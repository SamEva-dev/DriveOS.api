...
{
    public static IEndpointRouteBuilder MapOrganizationRepresentativeEndpoints(
    ...
    )
    {
        ...
        group
            .MapGet("/{representativeId:guid}", GetByIdAsync)
        ...
        group
            .MapPut("/{representativeId:guid}/authority", UpdateAuthorityAsync)
        ...
        group
            .MapPost("/{representativeId:guid}/activate", ActivateAsync)
        ...
        group
            .MapPost("/{representativeId:guid}/suspend", SuspendAsync)
        ...
        group
            .MapPost("/{representativeId:guid}/reactivate", ReactivateAsync)
        ...
        group
            .MapPost("/{representativeId:guid}/end", EndAsync)
            .WithName("EndOrganizationRepresentative")
            .Produces(StatusCodes.Status204NoContent)
            .RequireAuthorization(DriveOsPermissionCodes.OrganizationRepresentatives.End);

        group
            .MapPost("/{representativeId:guid}/set-primary-owner", SetPrimaryOwnerAsync)
            .WithName("SetPrimaryOrganizationOwner")
            .Produces(StatusCodes.Status204NoContent)
            .RequireAuthorization(
                DriveOsPermissionCodes.OrganizationRepresentatives.SetPrimaryOwner
            );
    ...
    )
    {
        ...
        Result<IReadOnlyCollection<OrganizationRepresentativeListItem>> result =
            await mediator.Send(
                new GetOrganizationRepresentativesQuery(organization, status),
                cancellationToken
            );
    ...
    )
    {
        if (
            !TryIds(
                ...
                context,
                out OrganizationId organization,
                out OrganizationRepresentativeId representative,
                out IResult? failure
            )
        )
            return failure!;
        ...
        Result<OrganizationRepresentativeResponse> result = await mediator.Send(
            new GetOrganizationRepresentativeByIdQuery(organization, representative),
            cancellationToken
        );
    ...
    private static Task<IResult> SetPrimaryOwnerAsync(
        Guid organizationId,
        Guid representativeId,
        ChangeOrganizationRepresentativeStatusRequest request,
        IMediator mediator,
    ...
    private static Task<IResult> SuspendAsync(
        Guid organizationId,
        Guid representativeId,
        ChangeOrganizationRepresentativeStatusWithReasonRequest request,
        IMediator mediator,
        IObjectMapper mapper,
        ICurrentTenant tenant,
        HttpContext context,
    ...
    private static async Task<IResult> ChangeStatusWithReasonAsync(
        Guid organizationId,
        Guid representativeId,
        ChangeOrganizationRepresentativeStatusWithReasonRequest request,
        IMediator mediator,
    ...
    private static async Task<IResult> EndAsync(
        Guid organizationId,
        Guid representativeId,
        EndOrganizationRepresentativeRequest request,
        IMediator mediator,
        IObjectMapper mapper,
        ICurrentTenant tenant,
        HttpContext context,
    ...
    )
    {
        ...
        Result result = await mediator.Send(
            mapper.Map<EndOrganizationRepresentativeApiModel, EndOrganizationRepresentativeCommand>(
                model
            ),
            cancellationToken
        );
    ...
    private static bool TryIds(
        Guid rawOrganizationId,
        Guid rawRepresentativeId,
        ICurrentTenant tenant,
        HttpContext context,
        out OrganizationId organizationId,
        out OrganizationRepresentativeId representativeId,
        out IResult? failure
    )
    {
