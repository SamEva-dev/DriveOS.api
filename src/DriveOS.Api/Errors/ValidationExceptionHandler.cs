...
public sealed class ValidationExceptionHandler : IExceptionHandler
{
    ...
    {
        ValidationException? validationException = ExtractValidationException(exception);
        ...
        var errors = validationException
            .Errors.Select(failure => new ApiErrorResponse(
                Type: "validation",
    ...
    private static ValidationException? ExtractValidationException(Exception exception)
    {
        ...
        if (
            exception is DomainRelayException
            {
    ...
    )
    {
        ...
        return failure.FormattedMessagePlaceholderValues.ToDictionary(
            item => item.Key,
