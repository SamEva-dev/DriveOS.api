...
public sealed class OrganizationSubscriptionsApiMappingProfile : MappingProfile
{
    ...
    {
        configuration.CreateMap<OrganizationSubscriptionResponse, OrganizationSubscriptionResponseContract>();
        configuration.CreateMap<SubscriptionPeriodResponse, SubscriptionPeriodResponseContract>();
        configuration.CreateMap<SubscriptionCancellationResponse, SubscriptionCancellationResponseContract>();
        configuration.CreateMap<SubscriptionEntitlementResponse, SubscriptionEntitlementResponseContract>();
        configuration.CreateMap<SubscriptionLimitResponse, SubscriptionLimitResponseContract>();

        configuration.CreateMap<CreateOrganizationSubscriptionApiModel, CreateOrganizationSubscriptionCommand>();
        configuration.CreateMap<ChangeOrganizationSubscriptionPlanApiModel, ChangeOrganizationSubscriptionPlanCommand>();
        configuration.CreateMap<ChangeOrganizationSubscriptionStatusApiModel, ChangeOrganizationSubscriptionStatusCommand>();
        configuration.CreateMap<CancelOrganizationSubscriptionApiModel, CancelOrganizationSubscriptionCommand>();
    }
}
