...
internal sealed class LeadConversionConfiguration : IEntityTypeConfiguration<LeadConversion>
{
    public void Configure(EntityTypeBuilder<LeadConversion> b)
    {
        ...
        b.Property(x => x.Id)
            .HasColumnName("id")
            .HasConversion(x => x.Value, x => new LeadConversionId(x))
            .ValueGeneratedNever();
        ...
        b.Property(x => x.AcceptedOfferId)
        ...
        b.Property(x => x.ResponsibleUserId)
