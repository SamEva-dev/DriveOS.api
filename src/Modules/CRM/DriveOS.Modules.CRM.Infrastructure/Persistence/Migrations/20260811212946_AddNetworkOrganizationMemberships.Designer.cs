...
namespace DriveOS.Modules.CRM.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260811212946_AddNetworkOrganizationMemberships")]
    partial class AddNetworkOrganizationMemberships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DriveOS.Modules.CRM.Domain.Offers.CommercialOffer", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "LeadId", "Version")
                        .IsUnique()
                        .HasDatabaseName("ux_commercial_offers_org_lead_version");

                    b.HasIndex("OrganizationId", "Status", "ValidUntilUtc")
                        .HasDatabaseName("ix_commercial_offers_org_status_valid_until");
