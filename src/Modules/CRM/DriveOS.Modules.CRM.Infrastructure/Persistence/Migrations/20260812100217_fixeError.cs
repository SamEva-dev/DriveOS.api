...
namespace DriveOS.Modules.CRM.Infrastructure.Persistence.Migrations
{
    ...
    public partial class fixeError : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    questionnaire_code = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    ...
                    factual_observations = table.Column<string>(
                        type: "character varying(8000)",
                        maxLength: 8000,
                        nullable: true
                    ),
                    pedagogical_interpretation = table.Column<string>(
                        type: "character varying(8000)",
                        maxLength: 8000,
                        nullable: true
                    ),
                    ...
                    internal_notes = table.Column<string>(
                        type: "character varying(8000)",
                        maxLength: 8000,
                        nullable: true
                    ),
                    prospect_comment = table.Column<string>(
                        type: "character varying(4000)",
                        maxLength: 4000,
                        nullable: true
                    ),
                    ...
                    last_saved_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    submitted_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    correction_reason = table.Column<string>(
                        type: "character varying(2000)",
                        maxLength: 2000,
                        nullable: true
                    ),
                    result_validated_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    result_validated_by_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    result_shared_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    discount_amount = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
                    ),
                    tax_rate = table.Column<decimal>(
                        type: "numeric(7,4)",
                        precision: 7,
                        scale: 4,
                        nullable: false
                    ),
                    net_amount = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
                    ...
                    price_source = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    manual_override_reason = table.Column<string>(
        ...
        {
            migrationBuilder.DropTable(name: "assessment_session_revisions", schema: "crm");

            migrationBuilder.DropTable(name: "commercial_offer_lines", schema: "crm");

            migrationBuilder.DropTable(name: "assessment_sessions", schema: "crm");
