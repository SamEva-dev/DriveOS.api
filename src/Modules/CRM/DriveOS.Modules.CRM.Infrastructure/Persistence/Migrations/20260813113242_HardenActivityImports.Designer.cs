...
namespace DriveOS.Modules.CRM.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260813113242_HardenActivityImports")]
    partial class HardenActivityImports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DriveOS.Modules.CRM.Domain.Activities.CrmActivity", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "AdvisorUserId", "OccurredAtUtc")
                    ...
                    b.ToTable("activities", "crm", t =>
                        {
                            t.HasCheckConstraint("ck_activities_duration_minutes", "duration_minutes IS NULL OR (duration_minutes >= 0 AND duration_minutes <= 1440)");

                            t.HasCheckConstraint("ck_activities_failed_sync_error", "sync_status <> 'Failed' OR sync_error_key IS NOT NULL");

                            t.HasCheckConstraint("ck_activities_import_metadata", "origin <> 'Imported' OR (external_id IS NOT NULL AND idempotency_key IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("DriveOS.Modules.CRM.Domain.Leads.SavedLeadView", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("OrganizationId", "Scope", "BranchId")
                        .HasDatabaseName("ix_saved_lead_views_scope");

                    b.ToTable("saved_lead_views", "crm");
                });
            ...
            modelBuilder.Entity("DriveOS.Modules.CRM.Domain.Activities.CrmActivity", b =>
                {
                    b.OwnsOne("DriveOS.Modules.CRM.Domain.Activities.CrmActivityMetadata", "Metadata", b1 =>
                        {
                            b1.Property<Guid>("CrmActivityId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<string>("AttachmentReference")
                                .HasMaxLength(1000)
                                .HasColumnType("character varying(1000)")
                            ...
                            b1.Property<bool>("IsUnfollowed")
                                .HasColumnType("boolean")
                                .HasColumnName("is_unfollowed");

                            b1.Property<DateTimeOffset?>("LastSyncAttemptAtUtc")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("last_sync_attempt_at_utc");
                            ...
                            b1.Property<bool>("RequiresRegularization")
                                .HasColumnType("boolean")
                                .HasColumnName("requires_regularization");
                            ...
                            b1.Property<int>("SyncAttemptCount")
                                .HasColumnType("integer")
                                .HasColumnName("sync_attempt_count");

                            b1.Property<string>("SyncErrorKey")
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("sync_error_key");
                            ...
                            b1.HasKey("CrmActivityId");

                            b1.ToTable("activities", "crm");
