...
public interface ITrainingCreditAccountRepository
{
    ...
    Task<TrainingCreditMovement?> GetMovementByReferenceAsync(TrainingCreditAccountId accountId, string reference, CancellationToken cancellationToken = default);
