...
{
    Task<BranchUserAssignmentItem?> GetByIdAsync(
        OrganizationId organizationId,
        BranchUserAssignmentId assignmentId,
        CancellationToken cancellationToken = default
    );

    Task<PagedResult<BranchUserAssignmentItem>> GetByBranchAsync(
        OrganizationId organizationId,
        BranchId branchId,
        int pageNumber,
        int pageSize,
    ...
    Task<PagedResult<BranchUserAssignmentItem>> GetByUserAsync(
        OrganizationId organizationId,
        UserId userId,
        int pageNumber,
        int pageSize,
