...
internal sealed class SuspendBranchUserAssignmentCommandValidator
    : AbstractValidator<SuspendBranchUserAssignmentCommand>
{
    public SuspendBranchUserAssignmentCommandValidator()
    {
