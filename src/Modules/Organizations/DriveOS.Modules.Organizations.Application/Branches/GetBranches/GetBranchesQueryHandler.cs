...
public sealed class GetBranchesQueryHandler(IBranchReadService branchReadService)
    : IQueryHandler<GetBranchesQuery, PagedResult<BranchListItem>>
{
    ...
    {
        PagedResult<BranchListItem> result = await branchReadService.GetPagedAsync(
