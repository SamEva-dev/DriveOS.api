...
namespace DriveOS.Modules.Organizations.Application.Branches;
...
public interface IBranchReadService
{
    ...
    Task<PagedResult<BranchListItem>> GetPagedAsync(
        OrganizationId organizationId,
        int pageNumber,
        int pageSize,
        string? search,
    ...
    Task<IReadOnlyList<BranchStatusHistoryItem>> GetStatusHistoryAsync(
        OrganizationId organizationId,
        BranchId branchId,
        CancellationToken cancellationToken
    );
