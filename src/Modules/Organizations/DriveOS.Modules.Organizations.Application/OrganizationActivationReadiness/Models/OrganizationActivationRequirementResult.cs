    ...
    IReadOnlyDictionary<string, object?> Parameters)
{
    public static OrganizationActivationRequirementResult Satisfied(
        string code,
        string messageKey) =>
        new(code, true, OrganizationActivationRequirementSeverity.Information, messageKey,
            new Dictionary<string, object?>());

    public static OrganizationActivationRequirementResult Missing(
        string code,
        string messageKey,
        OrganizationActivationRequirementSeverity severity = OrganizationActivationRequirementSeverity.Blocking,
        IReadOnlyDictionary<string, object?>? parameters = null) =>
        new(code, false, severity, messageKey,
