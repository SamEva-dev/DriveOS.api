...
public static class OrganizationClosureErrors
{
    ...
    public static readonly Error NotFound = Error.NotFound(
        "OrganizationClosures.NotFound",
        "errors.organizationClosures.notFound"
    );
    public static readonly Error CurrentUserRequired = Error.Unauthorized(
        "OrganizationClosures.CurrentUser.Required",
        "errors.authentication.required"
    );
    public static readonly Error InvalidAction = Error.Validation(
        "OrganizationClosures.Action.Invalid",
        "errors.organizationClosures.action.invalid"
    );
    public static readonly Error ReadinessBlocked = Error.Conflict(
        "OrganizationClosures.Readiness.Blocked",
        "errors.organizationClosures.readiness.blocked"
    );
    public static readonly Error OrchestrationFailed = Error.Conflict(
        "OrganizationClosures.Orchestration.Failed",
        "errors.organizationClosures.orchestration.failed"
    );
}
