...
public sealed class GetOrganizationsQueryValidator : AbstractValidator<GetOrganizationsQuery>
{
    public GetOrganizationsQueryValidator()
    {
        ...
        RuleFor(query => query.Search)
            ...
            .WithErrorCode("Organizations.Search.TooLong")
            .WithMessage("errors.organizations.search.tooLong");

        RuleFor(query => query.SortBy)
            .IsInEnum()
            .WithErrorCode("Organizations.Sort.Invalid")
            .WithMessage("errors.organizations.sort.invalid");

        RuleFor(query => query.SortDirection)
            .IsInEnum()
            .WithErrorCode("Organizations.SortDirection.Invalid")
            .WithMessage("errors.organizations.sortDirection.invalid");
    }
}
