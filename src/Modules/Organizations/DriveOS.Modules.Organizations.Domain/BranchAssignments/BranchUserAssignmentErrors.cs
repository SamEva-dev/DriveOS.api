...
public static class BranchUserAssignmentErrors
{
    ...
    public static readonly Error EmptyCreatedByUserId =
        Error.Validation(
            "BranchAssignments.CreatedBy.Empty",
            "errors.branchAssignments.createdBy.empty");

    public static readonly Error EmptyChangedByUserId =
        Error.Validation(
    ...
    public static readonly Error CannotModifyEnded =
        Error.Conflict(
            "BranchAssignments.Ended",
            "errors.branchAssignments.ended");

    public static readonly Error DuplicateActiveAssignment =
        Error.Conflict(
            "BranchAssignments.Duplicate",
            "errors.branchAssignments.duplicate");

    public static readonly Error PrimaryAssignmentAlreadyExists =
        Error.Conflict(
    ...
    public static readonly Error ClosedBranch =
        Error.Conflict(
