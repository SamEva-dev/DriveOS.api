...
public static class BranchErrors
{
    ...
    public static readonly Error InvalidBranchType = Error.Validation(
    ...
    public static readonly Error OrganizationMustBeActive = Error.Conflict(
    ...
    public static readonly Error ClosedBranchCannotBeModified = Error.Conflict(
        "Branches.Closed.CannotBeModified",
        "errors.branches.closed.cannotBeModified"
    );

    public static readonly Error ClosedBranchCannotBePrimary = Error.Conflict(
    ...
    public static readonly Error EmptyManagerUserId = Error.Validation(
        "Branches.Manager.UserId.Empty",
        "errors.branches.manager.userId.empty"
    );

    public static readonly Error EmptyAssignedByUserId = Error.Validation(
        "Branches.Manager.AssignedBy.Empty",
        "errors.branches.manager.assignedBy.empty"
    );

    public static readonly Error ManagerEffectiveDateInvalid = Error.Validation(
        "Branches.Manager.EffectiveDate.Invalid",
        "errors.branches.manager.effectiveDate.invalid"
    );

    public static readonly Error ClosedBranchCannotReceiveManager = Error.Conflict(
        "Branches.Manager.ClosedBranch",
        "errors.branches.manager.closedBranch"
    );

    public static readonly Error ActiveManagerRequired = Error.Conflict(
        "Branches.Manager.Required",
        "errors.branches.manager.required"
    );

    public static readonly Error CurrentManagerNotFound = Error.NotFound(
        "Branches.Manager.NotFound",
        "errors.branches.manager.notFound"
    );

    public static readonly Error ManagerEffectiveDateCannotBePast = Error.Validation(
        "Branches.Manager.EffectiveDate.Past",
        "errors.branches.manager.effectiveDate.past"
    );

    public static readonly Error ManagerEffectiveDateCannotBeFuture = Error.Validation(
