...
public interface IBranchUserAssignmentRepository
    : IRepository<BranchUserAssignment, BranchUserAssignmentId>
{
    ...
    Task<IReadOnlyCollection<BranchUserAssignment>> GetOpenAssignmentsByUserAsync(
        OrganizationId organizationId,
        UserId userId,
    ...
    Task<IReadOnlyCollection<BranchUserAssignment>> GetOpenAssignmentsByBranchAsync(
        OrganizationId organizationId,
        BranchId branchId,
        bool asNoTracking = false,
        CancellationToken cancellationToken = default
