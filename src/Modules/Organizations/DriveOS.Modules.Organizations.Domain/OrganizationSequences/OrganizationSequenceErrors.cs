...
public static class OrganizationSequenceErrors
{
    ...
    public static Error CodeTooLong(int maximumLength) => Error.Validation(
    ...
    public static Error PatternTooLong(int maximumLength) => Error.Validation(
    ...
    public static Error ConcurrencyRetryExhausted(int attempts) => Error.Conflict(
