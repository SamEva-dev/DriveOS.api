...
public static class OrganizationErrors
{
    ...
    public static readonly Error EmptyLegalName = Error.Validation(
    ...
    public static Error LegalNameTooLong(int maxLength) =>
        Error.Validation(
            ...
            parameters: new Dictionary<string, object?> { ["maxLength"] = maxLength }
        );
    ...
    public static readonly Error InvalidOrganizationType = Error.Validation(
        code: "Organizations.Type.Invalid",
        messageKey: "errors.organizations.type.invalid"
    );

    public static readonly Error LegalNameAlreadyExists = Error.Conflict(
