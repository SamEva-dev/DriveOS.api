...
{
    public void Configure(EntityTypeBuilder<BranchUserAssignment> builder)
    {
        builder.ToTable("branch_user_assignments", OrganizationsSchema.Name);
        ...
        builder
            ...
            .HasColumnName("id")
            .HasConversion(id => id.Value, value => new BranchUserAssignmentId(value))
            .ValueGeneratedNever();

        builder
            .Property(assignment => assignment.OrganizationId)
        ...
        builder
            .Property(assignment => assignment.Role)
            .HasColumnName("role")
        ...
        builder
            .Property(assignment => assignment.AssignmentType)
        ...
        builder
            .Property(assignment => assignment.StartsAtUtc)
            .HasColumnName("starts_at_utc")
            .IsRequired();

        builder
            .Property(assignment => assignment.PlannedEndAtUtc)
            .HasColumnName("planned_end_at_utc");

        builder
            .Property(assignment => assignment.EffectiveEndAtUtc)
            .HasColumnName("effective_end_at_utc");

        builder
            .Property(assignment => assignment.SuspensionReason)
            .HasColumnName("suspension_reason")
            .HasMaxLength(BranchAssignmentReason.MaximumLength);

        builder.Property(assignment => assignment.SuspendedAtUtc).HasColumnName("suspended_at_utc");

        builder
            .Property(assignment => assignment.SuspendedByUserId)
        ...
        builder
            .Property(assignment => assignment.EndReason)
        ...
        builder
            .Property(assignment => assignment.CreatedAtUtc)
            .HasColumnName("created_at_utc")
            .IsRequired();

        builder
            .Property(assignment => assignment.CreatedByUserId)
        ...
        builder
            .Property(assignment => assignment.LastModifiedAtUtc)
            .HasColumnName("last_modified_at_utc");

        builder
            .Property(assignment => assignment.LastModifiedByUserId)
