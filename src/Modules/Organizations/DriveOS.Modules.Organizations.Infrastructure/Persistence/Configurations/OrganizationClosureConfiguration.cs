...
public sealed class OrganizationClosureConfiguration : IEntityTypeConfiguration<OrganizationClosure>
{
    public void Configure(EntityTypeBuilder<OrganizationClosure> builder)
    {
        ...
        builder
            ...
            .IsRequired();
        builder
            .Property(x => x.ReasonDetails)
            .HasColumnName("reason_details")
            .HasMaxLength(OrganizationClosure.MaximumDetailsLength);
        builder
            .Property(x => x.RequestedEffectiveAtUtc)
            .HasColumnName("requested_effective_at_utc")
            .IsRequired();
        builder
            .Property(x => x.DataDisposition)
