    ...
    : IEntityTypeConfiguration<Domain.OrganizationConfigurations.OrganizationConfiguration>
{
    public void Configure(
        EntityTypeBuilder<Domain.OrganizationConfigurations.OrganizationConfiguration> builder
    )
    {
        ...
        builder
            .Property(configuration => configuration.VersionNumber)
            .HasColumnName("version_number")
            .IsRequired();

        builder
            .Property(configuration => configuration.CountryCode)
        ...
        builder
            .Property(configuration => configuration.Status)
        ...
        builder
            .Property(configuration => configuration.EffectiveFromUtc)
            .HasColumnName("effective_from_utc");
        builder
            .Property(configuration => configuration.EffectiveToUtc)
            .HasColumnName("effective_to_utc");
        builder
            .Property(configuration => configuration.PublishedAtUtc)
            .HasColumnName("published_at_utc");
        builder
            .Property(configuration => configuration.PublishedByUserId)
        ...
        builder
            .Property(configuration => configuration.Revision)
            .HasColumnName("revision")
            .IsConcurrencyToken()
            .IsRequired();

        builder
            .Property(configuration => configuration.CreatedAtUtc)
            .HasColumnName("created_at_utc")
            .IsRequired();
        builder
            .Property(configuration => configuration.CreatedByUserId)
        ...
        builder
            .Property(configuration => configuration.LastModifiedAtUtc)
            .HasColumnName("last_modified_at_utc");
        builder
            .Property(configuration => configuration.LastModifiedByUserId)
