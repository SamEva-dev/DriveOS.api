...
public sealed class OrganizationRepresentativeConfiguration
    : IEntityTypeConfiguration<OrganizationRepresentative>
{
    public void Configure(EntityTypeBuilder<OrganizationRepresentative> builder)
    {
        ...
        builder
            .Property(x => x.Id)
            .HasColumnName("id")
            .HasConversion(id => id.Value, value => new OrganizationRepresentativeId(value));
        builder
        ...
        builder
            .Property(x => x.RepresentativeType)
        ...
        builder.OwnsOne(
            ...
            scope =>
            {
                scope
                    ...
                    .HasMaxLength(RepresentativeAuthorityScope.MaximumLength)
                    .IsRequired();
            }
        );
        ...
        builder
            .HasOne<DriveOS.Modules.Organizations.Domain.Organizations.Organization>()
            .WithMany()
