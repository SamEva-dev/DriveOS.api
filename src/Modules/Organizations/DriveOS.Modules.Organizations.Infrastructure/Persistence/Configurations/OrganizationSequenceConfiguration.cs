    ...
    IEntityTypeConfiguration<OrganizationSequence>
{
    public void Configure(EntityTypeBuilder<OrganizationSequence> builder)
    {
        ...
        builder.Property(sequence => sequence.Id)
            .HasColumnName("id")
        ...
        builder.Property(sequence => sequence.BranchId)
        ...
        builder.Property(sequence => sequence.Code)
            .HasColumnName("code")
            .HasMaxLength(OrganizationSequence.CodeMaximumLength)
            .IsRequired();

        builder.OwnsOne(sequence => sequence.Pattern, pattern =>
        {
        ...
        builder.Property(sequence => sequence.Padding)
        ...
        builder.Property(sequence => sequence.ResetPolicy)
            .HasColumnName("reset_policy")
            .HasConversion<string>()
            .HasMaxLength(20)
            .IsRequired();

        builder.Property(sequence => sequence.LastResetYear)
            .HasColumnName("last_reset_year");

        builder.Property(sequence => sequence.LastResetMonth)
            .HasColumnName("last_reset_month");

        builder.Property(sequence => sequence.Status)
        ...
        builder.Property(sequence => sequence.CreatedAtUtc)
            .HasColumnName("created_at_utc")
            .IsRequired();

        builder.Property(sequence => sequence.CreatedByUserId)
            .HasColumnName("created_by_user_id")
            .HasConversion(
                id => id.HasValue ? id.Value.Value : (Guid?)null,
                value => value.HasValue ? new UserId(value.Value) : null);

        builder.Property(sequence => sequence.LastModifiedAtUtc)
            .HasColumnName("last_modified_at_utc");

        builder.Property(sequence => sequence.LastModifiedByUserId)
            .HasColumnName("last_modified_by_user_id")
            .HasConversion(
                id => id.HasValue ? id.Value.Value : (Guid?)null,
                value => value.HasValue ? new UserId(value.Value) : null);

        builder.HasIndex(sequence => new { sequence.OrganizationId, sequence.Code })
            .IsUnique()
