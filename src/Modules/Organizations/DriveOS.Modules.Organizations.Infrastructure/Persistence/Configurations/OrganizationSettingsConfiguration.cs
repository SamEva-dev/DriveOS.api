    ...
    IEntityTypeConfiguration<OrganizationSettings>
{
    public void Configure(EntityTypeBuilder<OrganizationSettings> builder)
    {
        ...
        builder.Property(settings => settings.Id)
            ...
            .HasConversion(
                id => id.Value,
                value => new OrganizationSettingsId(value))
            .ValueGeneratedNever();
        ...
        builder.OwnsOne(settings => settings.Profile, profile =>
        {
            profile.Property(value => value.TradeName)
                .HasColumnName("trade_name")
                .HasMaxLength(OrganizationProfile.TradeNameMaximumLength);

            profile.Property(value => value.RegistrationNumber)
                .HasColumnName("registration_number")
                .HasMaxLength(OrganizationProfile.RegistrationNumberMaximumLength);

            profile.Property(value => value.TaxNumber)
                .HasColumnName("tax_number")
                .HasMaxLength(OrganizationProfile.TaxNumberMaximumLength);
        });

        builder.OwnsOne(settings => settings.Contact, contact =>
        {
            ...
            contact.Property(value => value.Website)
                .HasColumnName("website")
                .HasMaxLength(OrganizationContactInformation.WebsiteMaximumLength);
        });

        builder.OwnsOne(settings => settings.Address, address =>
        {
        ...
        builder.OwnsOne(settings => settings.Regional, regional =>
        {
            regional.Property(value => value.DefaultLanguage)
                .HasColumnName("default_language")
                .HasMaxLength(15)
                .IsRequired();

            regional.Property(value => value.SupportedLanguages)
            ...
            regional.Property(value => value.TimeZoneId)
                .HasColumnName("time_zone_id")
                .HasMaxLength(OrganizationRegionalSettings.TimeZoneMaximumLength)
                .IsRequired();

            regional.Property(value => value.CurrencyCode)
                .HasColumnName("currency_code")
                .HasMaxLength(3)
                .IsFixedLength()
                .IsRequired();

            regional.Property(value => value.DateFormat)
                .HasColumnName("date_format")
                .HasMaxLength(OrganizationRegionalSettings.FormatMaximumLength)
                .IsRequired();

            regional.Property(value => value.TimeFormat)
                .HasColumnName("time_format")
                .HasMaxLength(OrganizationRegionalSettings.FormatMaximumLength)
                .IsRequired();

            regional.Property(value => value.FirstDayOfWeek)
                .HasColumnName("first_day_of_week")
                .HasConversion<string>()
                .HasMaxLength(20)
                .IsRequired();

            regional.Property(value => value.MeasurementSystem)
        ...
        builder.OwnsOne(settings => settings.Operational, operational =>
        {
            operational.Property(value => value.DefaultSessionDurationMinutes)
                .HasColumnName("default_session_duration_minutes")
                .IsRequired();

            operational.Property(value => value.DefaultBookingLeadTimeMinutes)
                .HasColumnName("default_booking_lead_time_minutes")
                .IsRequired();

            operational.Property(value => value.DefaultCancellationDelayHours)
                .HasColumnName("default_cancellation_delay_hours")
                .IsRequired();

            operational.Property(value => value.AllowStudentSelfBooking)
                .HasColumnName("allow_student_self_booking")
                .IsRequired();

            operational.Property(value => value.RequireBranchForOperations)
                .HasColumnName("require_branch_for_operations")
                .IsRequired();

            operational.Property(value => value.DefaultBranchId)
        ...
        builder.Property(settings => settings.LastModifiedAtUtc)
            .HasColumnName("last_modified_at_utc");

        builder.Property(settings => settings.LastModifiedByUserId)
