...
{
    public void Configure(EntityTypeBuilder<OrganizationStatusHistoryEntry> builder)
    {
        ...
        builder
            .Property(entry => entry.OrganizationId)
        ...
        builder
            .HasIndex(entry => new { entry.OrganizationId, entry.ChangedAtUtc })
