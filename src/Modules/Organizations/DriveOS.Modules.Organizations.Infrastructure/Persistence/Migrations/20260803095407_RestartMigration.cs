...
namespace DriveOS.Modules.Organizations.Infrastructure.Persistence.Migrations
{
    ...
    public partial class RestartMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    organization_id = table.Column<Guid>(type: "uuid", nullable: false),
                    trade_name = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
                    ...
                    address_country_code = table.Column<string>(
                        type: "character(2)",
                        fixedLength: true,
                        maxLength: 2,
                        nullable: false
                    ...
                    supported_languages = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    ...
                    date_format = table.Column<string>(
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: false
                    ),
                    time_format = table.Column<string>(
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: false
                    ),
                    first_day_of_week = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: false
                    ),
                    measurement_system = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: false
                    ),
                    default_session_duration_minutes = table.Column<int>(
                        type: "integer",
                        nullable: false
                    ),
                    default_booking_lead_time_minutes = table.Column<int>(
                        type: "integer",
                        nullable: false
                    ),
                    default_cancellation_delay_hours = table.Column<int>(
                        type: "integer",
                        nullable: false
                    ),
                    allow_student_self_booking = table.Column<bool>(
                        type: "boolean",
                        nullable: false
                    ),
                    require_branch_for_operations = table.Column<bool>(
                        type: "boolean",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_period_starts_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    current_period_ends_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    trial_starts_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    trial_ends_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    cancellation_requested_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    cancellation_effective_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    cancellation_requested_by_user_id = table.Column<Guid>(
                        type: "uuid",
                        nullable: true
                    ),
                    external_provider = table.Column<string>(
                        type: "character varying(80)",
                        maxLength: 80,
                        nullable: true
                    ),
                    external_subscription_id = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    assigned_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    assignment_type = table.Column<string>(
                        type: "character varying(30)",
                        maxLength: 30,
                        nullable: false
                    ),
                    ...
                    planned_end_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    effective_end_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    suspension_reason = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    suspended_at_utc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    suspended_by_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    end_reason = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    entitlement_code = table.Column<string>(
                        type: "character varying(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    organization_subscription_id = table.Column<Guid>(
                        type: "uuid",
                        nullable: false
                    ),
                },
                ...
                {
                    table.PrimaryKey(
                        "PK_organization_subscription_entitlements",
                        x => new { x.organization_subscription_id, x.entitlement_code }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    limit_code = table.Column<string>(
                        type: "character varying(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                ...
                {
                    table.PrimaryKey(
                        "PK_organization_subscription_limits",
                        x => new { x.organization_subscription_id, x.limit_code }
                    );
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "branch_manager_assignments", schema: "organization");

            migrationBuilder.DropTable(name: "branch_status_history", schema: "organizations");

            migrationBuilder.DropTable(name: "branch_user_assignments", schema: "organization");

            migrationBuilder.DropTable(name: "organization_settings", schema: "organization");

            migrationBuilder.DropTable(name: "organization_status_history", schema: "organization");
            ...
            migrationBuilder.DropTable(name: "organization_subscriptions", schema: "organization");
