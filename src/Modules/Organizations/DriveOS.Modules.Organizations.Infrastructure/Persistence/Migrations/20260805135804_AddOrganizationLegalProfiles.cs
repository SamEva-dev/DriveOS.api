...
namespace DriveOS.Modules.Organizations.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddOrganizationLegalProfiles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    registered_address_line1 = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: false
                    ),
                    registered_address_line2 = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
                    registered_postal_code = table.Column<string>(
                        type: "character varying(30)",
                        maxLength: 30,
                        nullable: false
                    ),
                    registered_city = table.Column<string>(
                        type: "character varying(120)",
                        maxLength: 120,
                        nullable: false
                    ),
                    registered_region = table.Column<string>(
                        type: "character varying(120)",
                        maxLength: 120,
                        nullable: true
                    ),
                    registered_country_code = table.Column<string>(
                        type: "character(2)",
                        fixedLength: true,
                        maxLength: 2,
                        nullable: false
        ...
        {
            migrationBuilder.DropTable(name: "organization_legal_profiles", schema: "organization");
        }
    }
}
