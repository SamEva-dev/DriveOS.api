...
internal sealed class
    BranchUserAssignmentReadService(
        OrganizationsDbContext dbContext)
    : IBranchUserAssignmentReadService
{
    public Task<BranchUserAssignmentItem?>
        GetByIdAsync(
    ...
    private static System.Linq.Expressions
        .Expression<
            Func<
                BranchUserAssignment,
                BranchUserAssignmentItem>>
        MapItem()
    {
        return assignment =>
            new BranchUserAssignmentItem(
                ...
                assignment.LastModifiedByUserId
                    .HasValue
                    ? assignment
