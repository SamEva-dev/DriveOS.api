    ...
    : IOrganizationReadService
{
    ...
    public async Task<PagedResult<OrganizationListItem>>
    GetPagedAsync(
        int pageNumber,
        int pageSize,
        string? search,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new PagedResult<OrganizationListItem>(
            items,
            pageNumber,
            pageSize,
            totalCount);
    ...
    private static IQueryable<Organization>
    ApplySorting(
        IQueryable<Organization> query,
        OrganizationSortField sortBy,
        SortDirection sortDirection)
    ...
    public async Task<IReadOnlyList<OrganizationStatusHistoryItem>>
        ...
        CancellationToken cancellationToken)
    {
        return await _dbContext
            ...
            .OrderByDescending(entry =>
                entry.ChangedAtUtc)
            .Select(entry =>
                new OrganizationStatusHistoryItem(
                    entry.Id,
