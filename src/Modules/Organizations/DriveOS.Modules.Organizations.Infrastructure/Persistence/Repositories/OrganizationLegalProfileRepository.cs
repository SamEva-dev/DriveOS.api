...
internal sealed class OrganizationLegalProfileRepository(
    OrganizationsDbContext dbContext) : IOrganizationLegalProfileRepository
{
    public Task<OrganizationLegalProfile?> GetForUpdateAsync(
        OrganizationId organizationId,
        CancellationToken cancellationToken = default) =>
        dbContext.OrganizationLegalProfiles
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return dbContext.OrganizationLegalProfiles
            ...
            .AnyAsync(x =>
                ...
                (!excludingOrganizationId.HasValue || x.OrganizationId != excludingOrganizationId.Value),
                cancellationToken);
    }
