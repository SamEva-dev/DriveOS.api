...
internal sealed class OrganizationRepository(OrganizationsDbContext dbContext)
    : IOrganizationRepository
{
    ...
    )
    {
        return await dbContext
            ...
            .AnyAsync(
                organization =>
                    organization.LegalName == legalName && organization.CountryCode == countryCode,
                cancellationToken
            );
    }
    ...
    {
        return await ApplyTracking(dbContext.Organizations, asNoTracking)
    ...
    public async Task AddAsync(Organization entity, CancellationToken cancellationToken = default)
    {
