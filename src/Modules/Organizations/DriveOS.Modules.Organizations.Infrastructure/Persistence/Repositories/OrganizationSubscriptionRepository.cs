...
internal sealed class OrganizationSubscriptionRepository(
    OrganizationsDbContext dbContext) : IOrganizationSubscriptionRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        return await dbContext.OrganizationSubscriptions
            .Include(subscription => subscription.Entitlements)
