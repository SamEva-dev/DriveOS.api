...
public sealed class RecordTrainingSessionAttendanceCommandHandler(
    ...
    : ICommandHandler<RecordTrainingSessionAttendanceCommand, TrainingSessionResponse>
{
    public async Task<Result<TrainingSessionResponse>> Handle(RecordTrainingSessionAttendanceCommand command, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            Result<SessionAttendance> result = session.RecordAttendance(
                command.OperationId,
                command.Status,
                ...
                command.ActorUserId,
                clock.UtcNow,
                options.RecordingEarlyToleranceMinutes);
