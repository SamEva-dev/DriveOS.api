...
{
    private static readonly DateTimeOffset DefaultChangedAtUtc =
        new(
            2026,
            7,
            29,
    ...
    private static readonly Guid DefaultChangedByUserId =
            ...
            OrganizationType.DrivingSchool)
    {
        ...
        if (result.IsFailure)
        {
            throw new InvalidOperationException(
                $"Unable to create test organization. " +
